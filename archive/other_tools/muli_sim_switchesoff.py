...
#v90102
#v90103
mversion = ['v90103','v90103','v90103','v90103','v90103']

#Resolution
#4x5
#2x2.5
#0.5x0.666 Nested Europe
res = ['4x5','4x5','4x5','4x5','4x5']

#Met.
#GEOS 5
#MERRA
met = ['GEOS 5','GEOS 5','GEOS 5','GEOS 5','GEOS 5']

description = ['Standard 4x5','Convect off 4x5','Dry Dep off 4x5','Emissions off 4x5','Transport off 4x5'] 
...
cut_obs_periods, smoothed_obs = modules.ema_keep_peaks(reversed_fb,reversed_obs_periods,40,1200000)
...
model_list = ['binary_logs/GEOS_v90103_4x5_GAW_O3_logs.npy','binary_logs/convectoff_gaw_logs_O3.npy','binary_logs/drydepoff_gaw_logs_O3.npy','binary_logs/emissionsoff_gaw_logs_O3.npy','binary_logs/transportoff_gaw_logs_O3.npy']
...
#Smooth using exponetial smoother, last 2 numbers inputted are: smoothing window & cut-off point
	cut_model_periods, smoothed_model = modules.ema_keep_peaks(reversed_fy,reversed_model_periods,40,120000)
	smoothed_model = np.exp(smoothed_model)

#plot up
	#plt.loglog(cut_model_periods, smoothed_model, color=cm.jet(1.*i/len(mversion)) , marker = 'x', alpha = 0.75,markersize=2, label='%s %s' %(actual_species_name, description[counter]))
	plt.loglog(cut_model_periods, smoothed_model, marker = 'x', alpha = 0.75,markersize=2, label='%s %s' %(actual_species_name, description[counter]))
