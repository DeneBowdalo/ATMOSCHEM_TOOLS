...
def fasper(x, y, ofac=1, hifac=2 , MACC=4):
  ...
  #Max Frequency set
    fmax = np.float64(1.0/pmin)
  #Min Frequency set
    fmin = np.float64(1.0/pmax)
  ...
  #extirpolate the data into the workspaces  
    wk1 = np.zeros(nwk, dtype='complex')
    wk2 = np.zeros(nwk, dtype='complex')
