...
camchem_3311_o3 = movingaverage(camchem_3311_o3,window_size)
camchem_3514_o3 = movingaverage(camchem_3514_o3,window_size)
cam_sr1_o3 = movingaverage(cam_sr1_o3,window_size)
chaser_o3 = movingaverage(chaser_o3,window_size)
frsgcuci_o3 = movingaverage(frsgcuci_o3,window_size)
gemaq_o3 = movingaverage(gemaq_o3,window_size)
geoschem_o3 = movingaverage(geoschem_o3,window_size)
giss_o3 = movingaverage(giss_o3,window_size)
giss_alt_o3 = movingaverage(giss_alt_o3,window_size)
inca_o3 = movingaverage(inca_o3,window_size)
llnl_o3 = movingaverage(llnl_o3,window_size)
mozart_o3 = movingaverage(mozart_o3,window_size)
mozech_o3 = movingaverage(mozech_o3,window_size)
oslo_o3 = movingaverage(oslo_o3,window_size)
