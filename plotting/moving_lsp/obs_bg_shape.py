...
obs_refs = ['hedo','ijira','rishiri','tappi','yusuhara','ryo','tkb','yon']
#obs_refs = ['ice','abis0007a']
#obs_refs = ['arh','mcm','nmy','syo']
#obs_refs = ['alt','ca0420g','dk0010g','no0042g','brw','020680003']
...
h25, = ax.plot([1,1],color=plt.cm.cool(obsn_linspace[24]),marker='o',linestyle='None',markersize=8)

plt.legend((h1,h2,h3,h4,h5,h6,h7,h8,h9,h10,h11,h12,h13,h14,h15,h16,h17,h18,h19,h20,h21,h22,h23,h24,h25),['83-88','84-89','85-90','86-91','87-92','88-93','89-94','90-95','91-96','92-97','93-98','94-99','95-00','96-01','97-02','98-03','99-04','00-05','01-06','02-07','03-08','04-09','05-10','06-11','07-12'],loc='lower left',prop={'size':14},fancybox=True,ncol=5,markerscale=1,bbox_to_anchor=(-2.5,0.1))
