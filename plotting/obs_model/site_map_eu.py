...
m = Basemap(projection='cyl',llcrnrlat=30,urcrnrlat=72,\
                      llcrnrlon=-13,\
                      urcrnrlon=37,\
                      resolution='c')
...
areas = ['S_EU','SW_EU','CW_EU','CS_EU','C_EU','E_EU','NW_EU','N_EU']
...
for i in range(len(valid_refs)):
    ...
    try:
        m.scatter(x, y, color=color_dict[obs_area],s=35,alpha=1.)
    except:
        pass
