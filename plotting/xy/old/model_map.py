...
if param == 'mag':
    if period_type == 'd':
        diff = model_daily_mag
    if period_type == 's':
        diff = model_seasonal_mag

if param == 'ph_max':
    if period_type == 'd':
        diff = model_daily_phase
    if period_type == 's':
        diff = model_seasonal_phase

if param == 'ph_min':
    if period_type == 'd':
        diff = model_daily_phase_min
    if period_type == 's':
        diff = model_seasonal_phase_min
...
if param == 'ff':
    if period_type == 'd':
        diff = model_daily_ff
    if period_type == 's':
        diff = model_seasonal_ff
        
if param == 'pv':
    if period_type == 'd':
        diff = diurnal_model_frac
    if period_type == 's':
        diff = seasonal_model_frac
    if period_type == 'a':
        diff = all_model_frac
