...
start = datetime.datetime(year = int(start_year), month = 1, day = 1, hour = 0, minute = 0)
end = datetime.datetime(year = int(end_year), month = 1, day = 1, hour = 0, minute = 0)
