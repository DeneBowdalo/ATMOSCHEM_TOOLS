...
for c in range(len(start_years)):
    ...
    #read in obs names
    model_root_grp = Dataset('/work/home/db876/plotting_tools/model_files/GFDLAM3_SURFACE_%s_%s_%s_*_*_*_H_*.nc'%(species,sy,ey))
    ...
    root_grp_period = Dataset('GFDLAM3_historical_sig_periods_%s_%s.nc'%(sy,ey), 'w')
