...
#y = np.load('OMI_O3_trop_ave_2x2.5_gridstack.npy')
...
#save fft magitude
np.save('../plot/obs_magnitudes_2x2.5/obs_half_annual_magnitudes',half_annual_mag_array)
np.save('../plot/obs_magnitudes_2x2.5/obs_annual_magnitudes',annual_mag_array)

#save fft phase
np.save('../plot/obs_phases_2x2.5/obs_half_annual_phases',half_annual_phase_array)
np.save('../plot/obs_phases_2x2.5/obs_annual_phases',annual_phase_array)

#save average
np.save('obs_averages_2x2.5',mean_array)
