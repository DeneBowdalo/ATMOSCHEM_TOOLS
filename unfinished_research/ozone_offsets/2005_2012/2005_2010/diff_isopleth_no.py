...
model_fname = '/work/home/db876/plotting_tools/model_files/GEOSCHEM_SURFACE_NO_2005_2012_v902_2x2.5_GEOS5_H_*.nc'
model_ts_grp = Dataset(model_fname)
model_no2_var = model_ts_grp.variables['no'][:]*1e9
...
obs_no2_grp = Dataset('/work/home/db876/observations/surface/NO/process/GLOBAL_SURFACE_NO_1970_2015_H_ALL.nc')
...
for ref in obs_no2_refs:
    ...
    obs_no2_data.append(obs_site_group.variables['no'][:])
...
areas = ['NE_NA','CE_NA','NW_NA','C_NA','S_EU','C_EU','NW_EU','N_EU','N_O'] 
