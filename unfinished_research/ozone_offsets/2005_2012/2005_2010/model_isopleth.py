...
#x_ticks = [[0.1,0.25,0.5,1,2.5,5,10,25,50,100],[0.1,0.25,0.5,1,2.5,5,10,25,50,100],[0.1,0.25,0.5,1,2.5,5,10,25,50],[0.1,0.25,0.5,1,2.5,5,10,25,50],[0.25,0.5,1,2.5,5,10,25,50],[0.25,0.5,1,2.5,5,10,25,50],[0.25,0.5,1,2.5,5,10,25,50],[0.1,0.25,0.5,1,2.5,5,10,25],[0.25,0.5,1,2.5,5,10,25,50],[0.1,0.25,0.5,1,2.5,5,10,25,50]]
...
for ax in axes.flat:
    ...
    for x in range(len(no2_box_edges)-1):
        for y in range(len(co_box_edges)-1):  
            ...
            test = (lower_no2 <= model_no2_cut_ave) & (upper_no2 > model_no2_cut_ave) & (lower_co <= model_co_cut_ave) & (upper_co > model_co_cut_ave)
            
            box_ave_o3 = np.nanmean(model_o3_cut_ave[test])
            
            fill_box[x,y] = box_ave_o3
    
    #cb = ax.scatter(np.log(model_no2_cut_ave),np.log(model_co_cut_ave),s=5,c=model_o3_cut_ave,vmin=0,vmax=70,edgecolors='none')    
    ...
    #ax.set_xlim(0,no2_max[count])
    #ax.set_ylim(0,co_max[count])
    #ax.set_xlim(np.log(np.min(x_ticks[count])),np.log(np.max(x_ticks[count])))
    #ax.set_ylim(np.log(np.min(y_ticks[count])),np.log(np.max(y_ticks[count])))
    
    #ax.set_xticks(np.log(x_ticks[count]))
    #ax.set_yticks(np.log(y_ticks[count]))
    #ax.set_xticklabels(x_ticks[count])
    #ax.set_yticklabels(y_ticks[count])
