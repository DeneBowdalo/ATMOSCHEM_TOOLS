...
#end = datetime.datetime(year = start_year, month = 1, day = 2, hour = 0, minute = 0)
...
ani.save('%s_HOURLY_video_2005_2010_AREAS.mp4'%(species), 'ffmpeg',fps=framerate,extra_args=['-vcodec','libx264', '-s','hd1080', '-pix_fmt', 'yuv420p'])    
